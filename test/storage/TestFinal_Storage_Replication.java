    ...
    protected void initialize() throws TestFailed, IOException, InterruptedException {
        ...
        while (true) {
            try {
                ...
                storage_socket.connect(new InetSocketAddress("127.0.0.1", second_client_port), 1000);
                registration_socket = new Socket();
                registration_socket.connect(new InetSocketAddress("127.0.0.1", second_command_port), 1000);
                break;
            } catch (IOException e) {
