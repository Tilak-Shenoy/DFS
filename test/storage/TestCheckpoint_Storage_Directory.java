 ...
 */
public class TestCheckpoint_Storage_Directory extends StorageTest
{
    /** Test notice. */
    ...
    /** Creates the <code>TestCheckpoint_Storage_Directory</code> object. */
    public TestCheckpoint_Storage_Directory() {
    ...
    private void testCreate() throws TestFailed {
        ...
        try {
            ...
            response = getResponse("/storage_create", 7001, pathRequest);
        ...
        try {
            ...
            boolean success = gson.fromJson(response.body(), BooleanReturn.class).success;
            if(!success) {
                throw new TestFailed("unable to create new file in root directory");
            }
        } catch(TestFailed e) { 
            throw e; 
        } catch(Throwable t) {
    ...
    private void testDelete() throws TestFailed {
        ...
        try {
            pathRequest = new PathRequest("");
            response = getResponse("/storage_delete", 7001, pathRequest);
            String exception_type = gson.fromJson(response.body(), ExceptionReturn.class).exception_type;
            if (exception_type == null) {
