 ...
 */
public class TestFinal_Naming_Lock extends NamingTest
{
    /** Test notice. */
    public static final String notice = "checking naming server lock sharing and exclusion";
    /** Prerequisites. */
//    public static final Class[] prerequisites = new Class[] {TestCheckpoint_Naming_Registration.class};
    ...
    private void testBadPaths() throws TestFailed {
        ...
        try {
            ...
            if(exception_type == null) {
                throw new TestFailed("unlock method accepted null for path argument");
            } else if(DFSException.valueOf(exception_type) != DFSException.IllegalArgumentException) {
                throw new Throwable(response.body());
            }
        } catch(TestFailed e) { 
    ...
    protected void initialize() throws TestFailed {
        ...
        try {
            ...
            storage_server.start(registration_port, new Path[] {file1, file2}, null);
        } catch(Throwable t) {
    ...
    private class RendezvousUser extends LockUser {
        ...
        protected void locked() {
            synchronized(TestFinal_Naming_Lock.this) {
