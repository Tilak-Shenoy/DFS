 ...
 */
public class TestCheckpoint_Naming_Listing extends NamingTest {
    /** Test notice. */
    ...
    public TestCheckpoint_Naming_Listing() throws IOException {
    ...
    private void checkDirectoryListing(String path, String[] expected_children,
        ...
        if(listing == null) {
            throw new TestFailed("listing directory " + path + " resulted in null");
        }

        // Compare the result of the list method and the set of expected children.
        ...
        for(int child_index = 0; child_index < expected_children.length; ++child_index) {
            ...
            try {
                ...
                throw new TestFailed("unable to determine if " + child_path + " is a directory", t);
            }
    ...
    private void checkArguments() throws TestFailed {
        ...
        try {
            ...
            throw new TestFailed("isDirectory threw unexpected exception " +
                                 "when given a non-existent path as argument", t);
        }
        ...
        // Call isDirectory on the root directory, and ensure the result is true.
        ...
        try {
            ...
            throw new TestFailed("unable to determine if the root is a directory", t);
        }
    ...
    protected void initialize() throws TestFailed {
        ...
        try {
            storage_server.start(registration_port, new Path[] {file1, file2, file3}, null);
        } catch(Throwable t) {
